...
public class BidirectionalAstar : Pathfinding
{
    ...
    //    FindPathJob job2 = new FindPathJob
    //    {
    //        startPosition = new int2(end.x, end.y),
    //        endPosition = new int2(start.x, start.y),
    //        mapSize = new int2(MapManager.MapSize.x, MapManager.MapSize.y),
