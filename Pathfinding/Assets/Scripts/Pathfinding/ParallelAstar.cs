...
public class ParallelAstar : Pathfinding
{
    private class Node
    {
    ...
    void ProcessNeighbors(Node parent)
    {
        ...
        for (int x = -1; x <= 1; x++)
        {
            for (int y = -1; y <= 1; y++)
            {
                ...
                visitedTiles.Enqueue(neighborPos);
                int threadIndex = i;
    ...
    void ExamineNeighbor(Vector2Int neighborPos, Node parent)
    {
